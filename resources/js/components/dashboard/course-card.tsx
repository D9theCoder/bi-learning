...
export function CourseCard({ enrollment, onResume }: CourseCardProps) {
    const { course, progress_percentage = 0, last_activity_at, next_lesson } = enrollment;
    ...
    return (
        <Card>
            ...
            <CardContent className="p-4">
                <CardTitle className="line-clamp-2 text-base">{course.title || 'Untitled Course'}</CardTitle>
                {last_activity_at && (
