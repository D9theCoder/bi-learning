        ...
        <Card className={className}>
            <CardContent className="p-6">
                ...
                <div className="mt-4 space-y-2">
                    <Progress value={progress} className="h-3" aria-label={`${Math.round(progress)}% progress to next level`} />
                    <div className="flex items-center justify-between text-xs text-muted-foreground">
                        <span>{xpRemaining.toLocaleString()} XP to Level {currentLevel + 1}</span>
                        {totalXp !== undefined && (
