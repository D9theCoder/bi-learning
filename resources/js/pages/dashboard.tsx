...
const DashboardStatsSection = memo(({ stats }: { stats: LearningStats }) => (
    <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-4" aria-label="Learning statistics">
        <StatCard
            icon={Flame}
...
const DashboardCoursesSection = memo(({ enrolledCourses }: { enrolledCourses: Enrollment[] }) => (
    <section aria-labelledby="courses-heading">
        <h2 id="courses-heading" className="mb-4 text-xl font-semibold">My Courses</h2>
...
const DashboardActivityChartSection = memo(({ weeklyActivityData }: { weeklyActivityData: { name: string; value: number }[] }) => (
    <section aria-labelledby="activity-heading">
        <h2 id="activity-heading" className="mb-4 text-xl font-semibold">Weekly Activity</h2>
        <Card>
...
const DashboardSidebar = memo(({
    ...
    <div className="flex flex-col gap-6" role="complementary" aria-label="Dashboard sidebar">
        {/* Level Progress */}
        ...
        <DashboardErrorBoundary>
            <section aria-labelledby="achievements-heading">
                <Card>
                    <CardHeader>
                        <CardTitle id="achievements-heading">Recent Achievements</CardTitle>
                    </CardHeader>
                ...
                <div className="grid gap-6 lg:grid-cols-3">
                    ...
                    <div className="flex flex-col gap-6 lg:col-span-2">
                        ...
                        {weekly_activity_data.length > 0 && (
                            <DashboardErrorBoundary>
                                <DashboardActivityChartSection weeklyActivityData={weekly_activity_data} />
                            </DashboardErrorBoundary>
                        )}
                    </div>
